    ...
    <div className='projectPerentDiv'>
      ...
      <div className='projectContainerMain'>
        ...
        <div className='moreEvents'>
          <Link to={'https://gdsc.community.dev/jalpaiguri-government-engineering-college-jalpaiguri/'}><Button endIcon={<DirectionsRunIcon />} variant='contained' sx={{width : '10vw' , height : '7vh' , margin : '0 auto'}}>More Events</Button></Link>
          </div>
      </div>
    </div>
  )
